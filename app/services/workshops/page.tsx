            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <motion.div variants={fadeIn}>
                ...
                <div className="prose prose-lg max-w-none">
                  <p>
                    Our workshops and educational programs are designed to inspire creativity, foster collaboration, and build practical skills. We offer tailored experiences for universities, organizations, and individuals who want to explore design, technology, and innovation in a hands-on way.
                  </p>
                  <p>
                    Each workshop is crafted to encourage experimentation and critical thinking, blending theory with real-world application. Participants leave with new skills, fresh perspectives, and a sense of accomplishment.
                  </p>
                </div>
              </motion.div>
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <motion.div variants={fadeIn} className="bg-white p-8 rounded-lg">
                ...
                <h3 className="text-xl mb-4">Needs Assessment</h3>
                <p className="text-gray-600">
                  We work with you to understand your goals and tailor the workshop content to your audience.
                </p>
              </motion.div>
              <motion.div variants={fadeIn} className="bg-white p-8 rounded-lg">
                <div className="text-4xl text-[#fb4e4e] mb-4">02</div>
                <h3 className="text-xl mb-4">Interactive Learning</h3>
                <p className="text-gray-600">
                  Our workshops blend theory and practice, using activities, discussions, and real-world projects.
                </p>
              </motion.div>
              <motion.div variants={fadeIn} className="bg-white p-8 rounded-lg">
                <div className="text-4xl text-[#fb4e4e] mb-4">03</div>
                <h3 className="text-xl mb-4">Reflection & Certification</h3>
                <p className="text-gray-600">
                  We encourage reflection and provide certificates of completion to recognize participants' achievements.
                </p>
              </motion.div>
            </div>
          </div>
        ...
        <section className="py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 md:px-6 text-center">
            ...
            <motion.p className="text-lg mb-8 max-w-2xl mx-auto" variants={fadeIn}>
              Join our workshops to gain new skills, collaborate with others, and explore the future of design and technology.
            </motion.p>
            <motion.div variants={fadeIn}>
              <Link
                href="/contact"
